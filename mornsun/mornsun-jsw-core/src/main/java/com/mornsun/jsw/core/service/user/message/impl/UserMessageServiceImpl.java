package com.mornsun.jsw.core.service.user.message.impl;
...
import com.mornsun.jsw.core.dao.user.message.IUserMessageDao;
 ...
 */
@Service
public class UserMessageServiceImpl extends BasePageHelperServiceImpl<UserMessageVo, IUserMessageDao>
    ...
    public long countByExample(UserMessageModelCriteria example) throws Exception {
        try {
            return usermessageDao.countByExample(example);
        } catch (Exception e) {
    ...
    public int deleteByExample(UserMessageModelCriteria example) throws Exception {
        try {
            return usermessageDao.deleteByExample(example);
        } catch (Exception e) {
            String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
            logger.error(msg, e);
            throw new Exception(msg, e);
    ...
    public int insertSelective(UserMessageVo record) throws Exception {
        try {
            return usermessageDao.insertSelective(record);
        } catch (Exception e) {
            String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
            logger.error(msg, e);
            throw new Exception(msg, e);
    ...
    public List<UserMessageVo> selectByExample(UserMessageModelCriteria example) throws Exception {
        try {
            return usermessageDao.selectByExample(example);
        } catch (Exception e) {
            String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
            logger.error(msg, e);
            throw new Exception(msg, e);
    ...
    public int updateByExampleSelective(UserMessageVo record, UserMessageModelCriteria example) throws Exception {
        try {
            return usermessageDao.updateByExampleSelective(record, example);
        } catch (Exception e) {
            String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
            logger.error(msg, e);
            throw new Exception(msg, e);
    ...
    public int updateByExample(UserMessageVo record, UserMessageModelCriteria example) throws Exception {
        try {
            return usermessageDao.updateByExample(record, example);
        } catch (Exception e) {
            String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
            logger.error(msg, e);
            throw new Exception(msg, e);
    ...
    public int updateByPrimaryKey(UserMessageVo record) throws Exception {
        try {
            return usermessageDao.updateByPrimaryKey(record);
        } catch (Exception e) {
            String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
            logger.error(msg, e);
            throw new Exception(msg, e);
