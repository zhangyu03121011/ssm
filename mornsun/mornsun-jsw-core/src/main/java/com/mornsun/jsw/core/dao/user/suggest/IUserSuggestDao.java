package com.mornsun.jsw.core.dao.user.suggest;
 ...
 */
public interface IUserSuggestDao extends IBasePageHelperDao<UserSuggestVo> {
  /**
   * 根据条件查询总数
   * 
   * @param example
   ...
   * @throws Exception
   */
  public int updateByExampleSelective(@Param("record") UserSuggestVo record, @Param("example") UserSuggestModelCriteria example) throws Exception;
   ...
   * @throws Exception
   */
  public int updateByExample(@Param("record") UserSuggestVo record, @Param("example") UserSuggestModelCriteria example) throws Exception;
