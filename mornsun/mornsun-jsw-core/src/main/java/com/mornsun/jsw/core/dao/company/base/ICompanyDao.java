package com.mornsun.jsw.core.dao.company.base;
 ...
 */
public interface ICompanyDao extends IBasePageHelperDao<CompanyVo> {
  /**
   * 根据条件查询总数
   * 
   * @param example
   ...
   * @throws Exception
   */
  public int updateByExampleSelective(@Param("record") CompanyVo record, @Param("example") CompanyModelCriteria example) throws Exception;
   ...
   * @throws Exception
   */
  public int updateByExample(@Param("record") CompanyVo record, @Param("example") CompanyModelCriteria example) throws Exception;
