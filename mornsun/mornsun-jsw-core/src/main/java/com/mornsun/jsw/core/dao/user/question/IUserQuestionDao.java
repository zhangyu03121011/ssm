package com.mornsun.jsw.core.dao.user.question;
 ...
 */
public interface IUserQuestionDao extends IBasePageHelperDao<UserQuestionVo> {
  /**
   * 根据条件查询总数
   * 
   * @param example
   ...
   * @throws Exception
   */
  public int updateByExampleSelective(@Param("record") UserQuestionVo record, @Param("example") UserQuestionModelCriteria example) throws Exception;
   ...
   * @throws Exception
   */
  public int updateByExample(@Param("record") UserQuestionVo record, @Param("example") UserQuestionModelCriteria example) throws Exception;
