package com.mornsun.jsw.core.dao.user.coupon;
 ...
 */
public interface IUserCouponDao extends IBasePageHelperDao<UserCouponVo> {
  /**
   * 根据条件查询总数
   * 
   * @param example
   ...
   * @throws Exception
   */
  public int updateByExampleSelective(@Param("record") UserCouponVo record, @Param("example") UserCouponModelCriteria example) throws Exception;
   ...
   * @throws Exception
   */
  public int updateByExample(@Param("record") UserCouponVo record, @Param("example") UserCouponModelCriteria example) throws Exception;
