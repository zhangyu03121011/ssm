package com.mornsun.jsw.core.dao.user.invite;
 ...
 */
public interface IUserInviteDao extends IBasePageHelperDao<UserInviteVo> {
  /**
   * 根据条件查询总数
   * 
   * @param example
   ...
   * @throws Exception
   */
  public int updateByExampleSelective(@Param("record") UserInviteVo record, @Param("example") UserInviteModelCriteria example) throws Exception;
   ...
   * @throws Exception
   */
  public int updateByExample(@Param("record") UserInviteVo record, @Param("example") UserInviteModelCriteria example) throws Exception;
