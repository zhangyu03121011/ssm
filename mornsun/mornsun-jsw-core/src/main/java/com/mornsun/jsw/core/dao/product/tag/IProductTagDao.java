package com.mornsun.jsw.core.dao.product.tag;
 ...
 */
public interface IProductTagDao extends IBasePageHelperDao<ProductTagVo> {
  /**
   * 根据条件查询总数
   * 
   * @param example
   ...
   * @throws Exception
   */
  public int updateByExampleSelective(@Param("record") ProductTagVo record, @Param("example") ProductTagModelCriteria example) throws Exception;
   ...
   * @throws Exception
   */
  public int updateByExample(@Param("record") ProductTagVo record, @Param("example") ProductTagModelCriteria example) throws Exception;
