package com.mornsun.jsw.core.dao.applyarea;
 ...
 */
public interface IApplyAreaDao extends IBasePageHelperDao<ApplyAreaVo> {
  /**
   * 根据条件查询总数
   * 
   * @param example
   ...
   * @throws Exception
   */
  public int updateByExampleSelective(@Param("record") ApplyAreaVo record, @Param("example") ApplyAreaModelCriteria example) throws Exception;
   ...
   * @throws Exception
   */
  public int updateByExample(@Param("record") ApplyAreaVo record, @Param("example") ApplyAreaModelCriteria example) throws Exception;
