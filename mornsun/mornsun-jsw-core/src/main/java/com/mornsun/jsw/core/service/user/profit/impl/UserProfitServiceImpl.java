package com.mornsun.jsw.core.service.user.profit.impl;
...
import com.mornsun.jsw.core.dao.user.profit.IUserProfitDao;
 ...
 */
@Service
public class UserProfitServiceImpl extends BasePageHelperServiceImpl<UserProfitVo, IUserProfitDao>
    ...
    public long countByExample(UserProfitModelCriteria example) throws Exception {
        try {
            return userprofitDao.countByExample(example);
        } catch (Exception e) {
    ...
    public int deleteByExample(UserProfitModelCriteria example) throws Exception {
        try {
            return userprofitDao.deleteByExample(example);
        } catch (Exception e) {
            String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
            logger.error(msg, e);
            throw new Exception(msg, e);
    ...
    public int insertSelective(UserProfitVo record) throws Exception {
        try {
            return userprofitDao.insertSelective(record);
        } catch (Exception e) {
            String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
            logger.error(msg, e);
            throw new Exception(msg, e);
    ...
    public List<UserProfitVo> selectByExample(UserProfitModelCriteria example) throws Exception {
        try {
            return userprofitDao.selectByExample(example);
        } catch (Exception e) {
            String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
            logger.error(msg, e);
            throw new Exception(msg, e);
    ...
    public int updateByExampleSelective(UserProfitVo record, UserProfitModelCriteria example) throws Exception {
        try {
            return userprofitDao.updateByExampleSelective(record, example);
        } catch (Exception e) {
            String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
            logger.error(msg, e);
            throw new Exception(msg, e);
    ...
    public int updateByExample(UserProfitVo record, UserProfitModelCriteria example) throws Exception {
        try {
            return userprofitDao.updateByExample(record, example);
        } catch (Exception e) {
            String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
            logger.error(msg, e);
            throw new Exception(msg, e);
    ...
    public int updateByPrimaryKey(UserProfitVo record) throws Exception {
        try {
            return userprofitDao.updateByPrimaryKey(record);
        } catch (Exception e) {
            String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
            logger.error(msg, e);
            throw new Exception(msg, e);
