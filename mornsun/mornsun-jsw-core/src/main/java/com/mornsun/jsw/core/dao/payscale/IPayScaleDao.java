package com.mornsun.jsw.core.dao.payscale;
 ...
 */
public interface IPayScaleDao extends IBasePageHelperDao<PayScaleVo> {
  /**
   * 根据条件查询总数
   * 
   * @param example
   ...
   * @throws Exception
   */
  public int updateByExampleSelective(@Param("record") PayScaleVo record, @Param("example") PayScaleModelCriteria example) throws Exception;
   ...
   * @throws Exception
   */
  public int updateByExample(@Param("record") PayScaleVo record, @Param("example") PayScaleModelCriteria example) throws Exception;
