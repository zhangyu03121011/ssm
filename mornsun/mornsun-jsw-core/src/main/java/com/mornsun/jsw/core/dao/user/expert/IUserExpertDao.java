package com.mornsun.jsw.core.dao.user.expert;
 ...
 */
public interface IUserExpertDao extends IBasePageHelperDao<UserExpertVo> {
  /**
   * 根据条件查询总数
   * 
   * @param example
   ...
   * @throws Exception
   */
  public int updateByExampleSelective(@Param("record") UserExpertVo record, @Param("example") UserExpertModelCriteria example) throws Exception;
   ...
   * @throws Exception
   */
  public int updateByExample(@Param("record") UserExpertVo record, @Param("example") UserExpertModelCriteria example) throws Exception;
