package com.mornsun.jsw.core.service.brand.impl;
...
import com.mornsun.jsw.api.model.brand.BrandModelCriteria;
import com.mornsun.jsw.api.vo.brand.BrandVo;
import com.mornsun.jsw.core.dao.brand.IBrandDao;
import com.mornsun.jsw.core.service.brand.IBrandService;
 ...
 */
@Service
public class BrandServiceImpl extends BasePageHelperServiceImpl<BrandVo, IBrandDao> implements IBrandService {
    ...
    public int updateByExampleSelective(BrandVo record, BrandModelCriteria example) throws Exception {
        try {
            return brandDao.updateByExampleSelective(record, example);
        } catch (Exception e) {
            String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
            logger.error(msg, e);
            throw new Exception(msg, e);
    ...
    public int updateByExample(BrandVo record, BrandModelCriteria example) throws Exception {
        try {
            return brandDao.updateByExample(record, example);
        } catch (Exception e) {
            String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
            logger.error(msg, e);
            throw new Exception(msg, e);
