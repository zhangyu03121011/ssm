...
import com.mornsun.jsw.core.service.product.base.IProductBaseService;
 ...
 */
@Service
public class ProductBaseApiImpl extends BasePageHelperProviderApiImpl<ProductBaseVo, IProductBaseService>
        implements IProductBaseApi {
    ...
    public long countByExample(ProductBaseModelCriteria example) throws Exception {
        try {
            return productbaseService.countByExample(example);
        } catch (Exception e) {
    ...
    public int deleteByExample(ProductBaseModelCriteria example) throws Exception {
        try {
            return productbaseService.deleteByExample(example);
        } catch (Exception e) {
            String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
            logger.error(msg, e);
            throw new Exception(msg, e);
    ...
    public int insertSelective(ProductBaseVo record) throws Exception {
        try {
            return productbaseService.insertSelective(record);
        } catch (Exception e) {
            String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
            logger.error(msg, e);
            throw new Exception(msg, e);
    ...
    public List<ProductBaseVo> selectByExample(ProductBaseModelCriteria example) throws Exception {
        try {
            return productbaseService.selectByExample(example);
        } catch (Exception e) {
            String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
            logger.error(msg, e);
            throw new Exception(msg, e);
    ...
    public int updateByExampleSelective(ProductBaseVo record, ProductBaseModelCriteria example) throws Exception {
        try {
            return productbaseService.updateByExampleSelective(record, example);
        } catch (Exception e) {
            String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
            logger.error(msg, e);
            throw new Exception(msg, e);
    ...
    public int updateByExample(ProductBaseVo record, ProductBaseModelCriteria example) throws Exception {
        try {
            return productbaseService.updateByExample(record, example);
        } catch (Exception e) {
            String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
            logger.error(msg, e);
            throw new Exception(msg, e);
    ...
    public int updateByPrimaryKey(ProductBaseVo record) throws Exception {
        try {
            return productbaseService.updateByPrimaryKey(record);
        } catch (Exception e) {
            String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
            logger.error(msg, e);
            throw new Exception(msg, e);
