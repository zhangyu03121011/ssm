package com.mornsun.jsw.core.dao.user.praise;
 ...
 */
public interface IUserPraiseDao extends IBasePageHelperDao<UserPraiseVo> {
  /**
   * 根据条件查询总数
   * 
   * @param example
   ...
   * @throws Exception
   */
  public int updateByExampleSelective(@Param("record") UserPraiseVo record, @Param("example") UserPraiseModelCriteria example) throws Exception;
   ...
   * @throws Exception
   */
  public int updateByExample(@Param("record") UserPraiseVo record, @Param("example") UserPraiseModelCriteria example) throws Exception;
