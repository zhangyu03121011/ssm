package com.mornsun.jsw.core.dao.user.answer;
 ...
 */
public interface IUserAnswerDao extends IBasePageHelperDao<UserAnswerVo> {
  /**
   * 根据条件查询总数
   * 
   * @param example
   ...
   * @throws Exception
   */
  public int updateByExampleSelective(@Param("record") UserAnswerVo record, @Param("example") UserAnswerModelCriteria example) throws Exception;
   ...
   * @throws Exception
   */
  public int updateByExample(@Param("record") UserAnswerVo record, @Param("example") UserAnswerModelCriteria example) throws Exception;
