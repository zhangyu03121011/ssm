package com.mornsun.jsw.core.dao.product.applyarea;
 ...
 */
public interface IProductApplyAreaDao extends IBasePageHelperDao<ProductApplyAreaVo> {
  /**
   * 根据条件查询总数
   * 
   * @param example
   ...
   * @throws Exception
   */
  public int updateByExampleSelective(@Param("record") ProductApplyAreaVo record, @Param("example") ProductApplyAreaModelCriteria example) throws Exception;
   ...
   * @throws Exception
   */
  public int updateByExample(@Param("record") ProductApplyAreaVo record, @Param("example") ProductApplyAreaModelCriteria example) throws Exception;
