package com.mornsun.jsw.core.service.user.answer.impl;
...
import com.mornsun.jsw.core.dao.user.answer.IUserAnswerDao;
 ...
 */
@Service
public class UserAnswerServiceImpl extends BasePageHelperServiceImpl<UserAnswerVo, IUserAnswerDao>
    ...
    public long countByExample(UserAnswerModelCriteria example) throws Exception {
        try {
            return useranswerDao.countByExample(example);
        } catch (Exception e) {
    ...
    public int deleteByExample(UserAnswerModelCriteria example) throws Exception {
        try {
            return useranswerDao.deleteByExample(example);
        } catch (Exception e) {
            String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
            logger.error(msg, e);
            throw new Exception(msg, e);
    ...
    public int insertSelective(UserAnswerVo record) throws Exception {
        try {
            return useranswerDao.insertSelective(record);
        } catch (Exception e) {
            String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
            logger.error(msg, e);
            throw new Exception(msg, e);
    ...
    public List<UserAnswerVo> selectByExample(UserAnswerModelCriteria example) throws Exception {
        try {
            return useranswerDao.selectByExample(example);
        } catch (Exception e) {
            String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
            logger.error(msg, e);
            throw new Exception(msg, e);
    ...
    public int updateByExampleSelective(UserAnswerVo record, UserAnswerModelCriteria example) throws Exception {
        try {
            return useranswerDao.updateByExampleSelective(record, example);
        } catch (Exception e) {
            String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
            logger.error(msg, e);
            throw new Exception(msg, e);
    ...
    public int updateByExample(UserAnswerVo record, UserAnswerModelCriteria example) throws Exception {
        try {
            return useranswerDao.updateByExample(record, example);
        } catch (Exception e) {
            String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
            logger.error(msg, e);
            throw new Exception(msg, e);
    ...
    public int updateByPrimaryKey(UserAnswerVo record) throws Exception {
        try {
            return useranswerDao.updateByPrimaryKey(record);
        } catch (Exception e) {
            String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
            logger.error(msg, e);
            throw new Exception(msg, e);
