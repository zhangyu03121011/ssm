package com.mornsun.jsw.core.dao.param;
 ...
 */
public interface IParamDao extends IBasePageHelperDao<ParamVo> {
  /**
   * 根据条件查询总数
   * 
   * @param example
   ...
   * @throws Exception
   */
  public int updateByExampleSelective(@Param("record") ParamVo record, @Param("example") ParamModelCriteria example) throws Exception;
   ...
   * @throws Exception
   */
  public int updateByExample(@Param("record") ParamVo record, @Param("example") ParamModelCriteria example) throws Exception;
