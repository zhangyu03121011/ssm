package com.mornsun.jsw.core.dao.user.employee;
 ...
 */
public interface IUserEmployeeDao extends IBasePageHelperDao<UserEmployeeVo> {
  /**
   * 根据条件查询总数
   * 
   * @param example
   ...
   * @throws Exception
   */
  public int updateByExampleSelective(@Param("record") UserEmployeeVo record, @Param("example") UserEmployeeModelCriteria example) throws Exception;
   ...
   * @throws Exception
   */
  public int updateByExample(@Param("record") UserEmployeeVo record, @Param("example") UserEmployeeModelCriteria example) throws Exception;
