package com.mornsun.jsw.core.dao.search.suggest;
 ...
 */
public interface ISearchSuggestDao extends IBasePageHelperDao<SearchSuggestVo> {
  /**
   * 根据条件查询总数
   * 
   * @param example
   ...
   * @throws Exception
   */
  public int updateByExampleSelective(@Param("record") SearchSuggestVo record, @Param("example") SearchSuggestModelCriteria example) throws Exception;
   ...
   * @throws Exception
   */
  public int updateByExample(@Param("record") SearchSuggestVo record, @Param("example") SearchSuggestModelCriteria example) throws Exception;
