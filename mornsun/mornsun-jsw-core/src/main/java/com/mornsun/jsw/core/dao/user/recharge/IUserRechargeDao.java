package com.mornsun.jsw.core.dao.user.recharge;
 ...
 */
public interface IUserRechargeDao extends IBasePageHelperDao<UserRechargeVo> {
  /**
   * 根据条件查询总数
   * 
   * @param example
   ...
   * @throws Exception
   */
  public int updateByExampleSelective(@Param("record") UserRechargeVo record, @Param("example") UserRechargeModelCriteria example) throws Exception;
   ...
   * @throws Exception
   */
  public int updateByExample(@Param("record") UserRechargeVo record, @Param("example") UserRechargeModelCriteria example) throws Exception;
