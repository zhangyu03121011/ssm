package com.mornsun.jsw.core.service.user.recharge.impl;
...
import com.mornsun.jsw.core.dao.user.recharge.IUserRechargeDao;
 ...
 */
@Service
public class UserRechargeServiceImpl extends BasePageHelperServiceImpl<UserRechargeVo, IUserRechargeDao>
    ...
    public long countByExample(UserRechargeModelCriteria example) throws Exception {
        try {
            return userrechargeDao.countByExample(example);
        } catch (Exception e) {
    ...
    public int deleteByExample(UserRechargeModelCriteria example) throws Exception {
        try {
            return userrechargeDao.deleteByExample(example);
        } catch (Exception e) {
            String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
            logger.error(msg, e);
            throw new Exception(msg, e);
    ...
    public int insertSelective(UserRechargeVo record) throws Exception {
        try {
            return userrechargeDao.insertSelective(record);
        } catch (Exception e) {
            String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
            logger.error(msg, e);
            throw new Exception(msg, e);
    ...
    public List<UserRechargeVo> selectByExample(UserRechargeModelCriteria example) throws Exception {
        try {
            return userrechargeDao.selectByExample(example);
        } catch (Exception e) {
            String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
            logger.error(msg, e);
            throw new Exception(msg, e);
    ...
    public int updateByExampleSelective(UserRechargeVo record, UserRechargeModelCriteria example) throws Exception {
        try {
            return userrechargeDao.updateByExampleSelective(record, example);
        } catch (Exception e) {
            String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
            logger.error(msg, e);
            throw new Exception(msg, e);
    ...
    public int updateByExample(UserRechargeVo record, UserRechargeModelCriteria example) throws Exception {
        try {
            return userrechargeDao.updateByExample(record, example);
        } catch (Exception e) {
            String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
            logger.error(msg, e);
            throw new Exception(msg, e);
    ...
    public int updateByPrimaryKey(UserRechargeVo record) throws Exception {
        try {
            return userrechargeDao.updateByPrimaryKey(record);
        } catch (Exception e) {
            String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
            logger.error(msg, e);
            throw new Exception(msg, e);
