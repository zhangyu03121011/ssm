package com.mornsun.jsw.core.dao.user.share;
 ...
 */
public interface IUserShareDao extends IBasePageHelperDao<UserShareVo> {
  /**
   * 根据条件查询总数
   * 
   * @param example
   ...
   * @throws Exception
   */
  public int updateByExampleSelective(@Param("record") UserShareVo record, @Param("example") UserShareModelCriteria example) throws Exception;
   ...
   * @throws Exception
   */
  public int updateByExample(@Param("record") UserShareVo record, @Param("example") UserShareModelCriteria example) throws Exception;
