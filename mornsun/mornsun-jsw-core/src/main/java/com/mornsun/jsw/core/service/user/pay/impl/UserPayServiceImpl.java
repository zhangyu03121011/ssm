package com.mornsun.jsw.core.service.user.pay.impl;
...
import com.mornsun.jsw.core.dao.user.pay.IUserPayDao;
 ...
 */
@Service
public class UserPayServiceImpl extends BasePageHelperServiceImpl<UserPayVo, IUserPayDao> implements IUserPayService {

    @Autowired
    private IUserPayDao userpayDao;
    ...
    public long countByExample(UserPayModelCriteria example) throws Exception {
        try {
            return userpayDao.countByExample(example);
        } catch (Exception e) {
    ...
    public int deleteByExample(UserPayModelCriteria example) throws Exception {
        try {
            return userpayDao.deleteByExample(example);
        } catch (Exception e) {
            String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
            logger.error(msg, e);
            throw new Exception(msg, e);
    ...
    public int insertSelective(UserPayVo record) throws Exception {
        try {
            return userpayDao.insertSelective(record);
        } catch (Exception e) {
            String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
            logger.error(msg, e);
            throw new Exception(msg, e);
    ...
    public List<UserPayVo> selectByExample(UserPayModelCriteria example) throws Exception {
        try {
            return userpayDao.selectByExample(example);
        } catch (Exception e) {
            String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
            logger.error(msg, e);
            throw new Exception(msg, e);
    ...
    public int updateByExampleSelective(UserPayVo record, UserPayModelCriteria example) throws Exception {
        try {
            return userpayDao.updateByExampleSelective(record, example);
        } catch (Exception e) {
            String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
            logger.error(msg, e);
            throw new Exception(msg, e);
    ...
    public int updateByExample(UserPayVo record, UserPayModelCriteria example) throws Exception {
        try {
            return userpayDao.updateByExample(record, example);
        } catch (Exception e) {
            String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
            logger.error(msg, e);
            throw new Exception(msg, e);
    ...
    public int updateByPrimaryKey(UserPayVo record) throws Exception {
        try {
            return userpayDao.updateByPrimaryKey(record);
        } catch (Exception e) {
            String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
            logger.error(msg, e);
            throw new Exception(msg, e);
