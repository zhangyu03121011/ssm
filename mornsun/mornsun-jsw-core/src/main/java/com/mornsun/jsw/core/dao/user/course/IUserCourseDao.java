package com.mornsun.jsw.core.dao.user.course;
 ...
 */
public interface IUserCourseDao extends IBasePageHelperDao<UserCourseVo> {
  /**
   * 根据条件查询总数
   * 
   * @param example
   ...
   * @throws Exception
   */
  public int updateByExampleSelective(@Param("record") UserCourseVo record, @Param("example") UserCourseModelCriteria example) throws Exception;
   ...
   * @throws Exception
   */
  public int updateByExample(@Param("record") UserCourseVo record, @Param("example") UserCourseModelCriteria example) throws Exception;
