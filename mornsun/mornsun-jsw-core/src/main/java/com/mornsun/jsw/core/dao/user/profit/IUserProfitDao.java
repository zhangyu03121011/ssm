package com.mornsun.jsw.core.dao.user.profit;
 ...
 */
public interface IUserProfitDao extends IBasePageHelperDao<UserProfitVo> {
  /**
   * 根据条件查询总数
   * 
   * @param example
   ...
   * @throws Exception
   */
  public int updateByExampleSelective(@Param("record") UserProfitVo record, @Param("example") UserProfitModelCriteria example) throws Exception;
   ...
   * @throws Exception
   */
  public int updateByExample(@Param("record") UserProfitVo record, @Param("example") UserProfitModelCriteria example) throws Exception;
