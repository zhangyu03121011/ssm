package com.mornsun.jsw.core.service.product.base;

import com.mornsun.jsw.api.vo.product.base.ProductVo;
import com.mornsun.jsw.api.model.product.base.ProductModelCriteria;
 ...
 */
public interface IProductService extends IBasePageHelperService<ProductVo> {
  /**
   * 根据条件查询总数
   * 
   * @param example
