...
function expandNode(e) {
	var zTree = $.fn.zTree.getZTreeObj("mornsunTree"), type = e.data.type, nodes = zTree.getSelectedNodes();
...
$.extend($.fn.validatebox.defaults.rules, {
    ...
    idcode: {// 验证idcode,从10000开始
        validator: function (value) {
            return /^[0-9]\d{4,15}$/i.test(value);
        },
        message: 'iD码格式不正确'
    },
    integer: {// 验证整数 可正负数
...
var currHost="http://120.76.65.211/";