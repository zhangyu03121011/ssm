...
function InitGrid(queryData) {
	$('#grid').datagrid({
		url:"user/answer/pagination?sessionId="+sessionId,
		title: '用户答案列表',
		iconCls: 'icon-view',
//		height: 650,
...
function BindAddEvent() {
	$("#btnAddOK").unbind("click").click(function() {
		...
		commPostRequest("user/answer/save", postData, function(){
...
function BindEditEvent() {
	$("#btnEditOK").unbind("click").click(function() {
		...
		commPostRequest("user/answer/update", postData, function(data) {
