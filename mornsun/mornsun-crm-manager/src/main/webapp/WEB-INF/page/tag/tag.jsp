...
<head>
    ...
    <script src="resources/js/tag/tag.js?r=${jsVersion }" type="text/javascript"></script>
    <link href="resources/css/tag/tag.css?r=${jsVersion }" rel="stylesheet" type="text/css" />
</head>
<body>
        ...
        <fieldset>
            ...
            <form id="ffSearch" method="post">
		        <div style="margin-bottom:5px">
                    ...
                    <input type="text" name="tagName" style="width:100px"  />&nbsp;&nbsp;&nbsp;
        ...
        <form id="ffAdd" method="post" novalidate="novalidate">
                <table id="tblAdd" class="view">
                    <tr>
                        ...
                        <td colspan="3">
                            <input class="easyui-validatebox" placeholder="请输入标签名称"  style="width: 465px;" type="text" name="tagName" data-options="required:true,validType:'length[1,50]'"/>
                        </td>
                    </tr>
                    <tr>
                        <th>
