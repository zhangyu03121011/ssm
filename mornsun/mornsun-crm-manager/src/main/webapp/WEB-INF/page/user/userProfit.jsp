...
<head>
    ...
    <script src="resources/js/user/userProfit.js?r=${jsVersion }" type="text/javascript"></script>
    <link href="resources/css/user/userProfit.css?r=${jsVersion }" rel="stylesheet" type="text/css" />
</head>
<body>
    ...
    <!--------------------------编辑信息的弹出层---------------------------->
    <div id="DivEdit" class="easyui-dialog" style="width:650px;height:420px;padding:10px 20px"
        ...
        <form id="ffEdit" method="post" novalidate="novalidate">
                <table id="tblEdit" class="view">
                    ...
                    <tr>
                        <th>
                            <label for="profitMoney">收益金额：</label>
                        </th>
                        <td>
                            <label name="profitMoney" />
                        </td>
                        <th>
    ...
    <!--------------------------查看详细信息的弹出层---------------------------->
    <div id="DivView" class="easyui-dialog" style="width:600px;height:420px;padding:10px 20px"
