...
<head>
    ...
    <script src="resources/js/position/position.js?r=${jsVersion }" type="text/javascript"></script>
    <link href="resources/css/position/position.css?r=${jsVersion }" rel="stylesheet" type="text/css" />
</head>
<body>
        ...
        <fieldset>
            ...
            <form id="ffSearch" method="post">
		        <div style="margin-bottom:5px">
                    <label for="positionName">头衔名称：</label>
                    <input type="text" name="positionName" style="width:100px"  />&nbsp;&nbsp;&nbsp;
        ...
        <form id="ffAdd" method="post" novalidate="novalidate">
                <table id="tblAdd" class="view">
                    <tr>
                        ...
                        <td colspan="3">
                            <input class="easyui-validatebox" placeholder="请输入头衔名称"  style="width: 465px;" type="text" name="positionName" data-options="required:true,validType:'length[1,50]'"/>
                        </td>
                    </tr>
                    <tr>
                        <th>
