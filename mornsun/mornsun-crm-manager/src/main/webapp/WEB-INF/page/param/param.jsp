...
<head>
    ...
    <script src="resources/js/param/param.js?r=${jsVersion }" type="text/javascript"></script>
    <link href="resources/css/param/param.css?r=${jsVersion }" rel="stylesheet" type="text/css" />
</head>
<body>
        ...
        <fieldset>
            ...
            <form id="ffSearch" method="post">
		        <div style="margin-bottom:5px">
                    ...
                    <select class="easyui-combotree" style="width:180px;" name="catalogId" id="searchCatalogTree"></select>&nbsp;&nbsp;&nbsp;
        ...
        <form id="ffAdd" method="post" novalidate="novalidate">
                <table id="tblAdd" class="view">
                    <tr>
                        ...
                        <td colspan="3">
                            <input class="easyui-validatebox" placeholder="请输入参数名称"  style="width: 465px;" type="text" name="paramName" data-options="required:true,validType:'length[1,50]'"/>
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td colspan="3">
                            <select class="easyui-combotree" style="width:300px;" name="catalogId" id="addCatalogTree"></select>
                        </td>
                    </tr>
                    <tr>
                        <th>
    ...
    <div id="DivUpload" class="easyui-dialog" style="width:550px;height:150px;padding:10px 20px"
			closed="true" resizable="true" modal="true" data-options="iconCls: 'icon-add',buttons: '#dlg-buttons'">
        <form id="ffUpload" method="post" novalidate="novalidate" enctype="multipart/form-data" action="param/import?sessionId=${sessionId}">
