package com.mornsun.crm.manager.inteceptor;
...
public class LoginInterceptor extends HandlerInterceptorAdapter implements PrivilegeConstant {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
        ...
        if (StringUtils.isEmpty(sessionId)) {
            ...
            response.sendRedirect(WebUtil.getInstance().getRealBasePath(request) + "admin");
        } else {
