 ...
 * @param <T>
 */
public class BaseControllerServiceImpl<T extends BaseModel, E extends IBaseDao<T>> extends BaseServiceImpl<T, E>
		implements IBaseControllerService<T> {
	 ...
	 * @return
	 */
	public ResultVo<T> detail(Serializable id, HttpServletRequest request) throws Exception {
		ResultVo<T> resultVo = new ResultVo<T>();
		int res = RESULT_FAILURE;
		try {
