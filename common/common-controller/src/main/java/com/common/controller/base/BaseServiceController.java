 ...
 * @param <E>
 */
public class BaseServiceController<T extends BaseModel, E extends IBaseControllerService<T>> extends BaseController {
	...
	public ResultVo<T> batch(@RequestBody List<T> list, HttpServletRequest request) {
		ResultVo<T> resultVo = new ResultVo<>();
		try {
