 ...
 * @param <E>
 */
public class BasePageHelperReferenceApiImpl<T, E extends IBasePageHelperProviderApi<T>>
		extends BaseReferenceApiImpl<T, E> implements IBasePageHelperReferenceApi<T> {
