 ...
 * @param <E>
 */
public class BasePageMybatisProviderApiImpl<T, E extends IBasePageMybatisService<T>> extends BaseProviderApiImpl<T, E>
		implements IBasePageMybatisProviderApi<T> {
