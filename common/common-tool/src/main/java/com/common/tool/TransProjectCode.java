...
import com.common.tool.util.BytesEncodingDetect;

public class TransProjectCode {

    private BytesEncodingDetect encode = new BytesEncodingDetect();

    private String projectPath = "E:\\Workspaces\\MyEclipse 8.5\\GmlSQL";// 获取项目目录
    ...
    /**
     * 对当前项目进行转码，会把当前项目覆盖 suf：规定要转码的文件后缀；charset：规定要转的编码
     */
    ...
    public static void main(String[] args) {
        new TransProjectCode().encoding("java", "utf-8");
    }
