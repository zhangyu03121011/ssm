 ...
 */
public class MybatisSiemsUtil {

	private String basePath = "E:\\Gml\\mornsun\\Svn\\project\\siems\\";

	private String modelPath = basePath + "siems-jsw-api\\src\\main\\java\\com\\siems\\jsw\\api\\model";

	private String apiPath = basePath + "siems-jsw-api\\src\\main\\java\\com\\siems\\jsw\\api\\api";

	private String voPath = basePath + "siems-jsw-api\\src\\main\\java\\com\\siems\\jsw\\api\\vo";

	private String daoPath = basePath + "siems-jsw-core\\src\\main\\java\\com\\siems\\jsw\\core\\dao";

	private String xmlPath = basePath + "siems-jsw-core\\src\\main\\resources\\com\\siems\\jsw\\core\\dao";

	private String apiImplPath = basePath + "siems-jsw-core\\src\\main\\java\\com\\siems\\jsw\\core\\api";

	private String servicePath = basePath + "siems-jsw-core\\src\\main\\java\\com\\siems\\jsw\\core\\service";

	private String serviceAppPath = basePath + "siems-buyself-core\\src\\main\\java\\com\\siems\\buyself\\core\\service";

	private String controllerAppPath = basePath
			+ "siems-buyself-manager\\src\\main\\java\\com\\siems\\buyself\\manager\\controller";

	private static Map<String, String> nameMapping = new HashMap<>();

	public MybatisSiemsUtil() {
	}
...
//		 controllerAppDeal();
	...
	public void generatorTableXml() {
		String tableList = "t_buyself_brand, t_buyself_brand_shop, t_buyself_customer, t_buyself_dept, t_buyself_dept_role, t_buyself_function, t_buyself_hardware, t_buyself_log, t_buyself_media, t_buyself_menu, t_buyself_product, t_buyself_product_atta, t_buyself_product_shop, t_buyself_product_type, t_buyself_role, t_buyself_role_menu, t_buyself_role_menu_function, t_buyself_shop, t_buyself_terminal_soft, t_buyself_user, t_buyself_user_role";
		String[] tableArray = tableList.split(",");
		String templates = "<table schema=\"siems\" tableName=\"@1@\" domainObjectName=\"@2@\"/>";
		String prefix = "t_buyself_";
		String suffix = "Model";
		...
		for (File file : modelFileList) {
			...
			if (!file.getName().endsWith("ModelCriteria.java")) {
				...
				try {
					...
					TableVO tableVO = dataSource.getTableInfo("siems", null,
				...
				try {
					...
					while (lineIterator.hasNext()) {
						...
						if (line.matches("package\\scom\\..*")) {
							line = line.replaceAll(".jsw.", ".buyself.");
						}
