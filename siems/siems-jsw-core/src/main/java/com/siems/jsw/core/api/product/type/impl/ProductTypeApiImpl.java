package com.siems.jsw.core.api.product.type.impl;
 ...
 */
@Service
public class ProductTypeApiImpl extends BasePageHelperProviderApiImpl<ProductTypeVo,IProductTypeService>  implements IProductTypeApi {  
  ...
  public long countByExample(ProductTypeModelCriteria example) throws Exception{
    try {
        return producttypeService.countByExample(example);
    } catch (Exception e) {
  ...
  public int deleteByExample(ProductTypeModelCriteria example) throws Exception{
    try {
        return producttypeService.deleteByExample(example);
    } catch (Exception e) {
        String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
        logger.error(msg, e);
        throw new Exception(msg, e);
  ...
  public int insertSelective(ProductTypeVo record) throws Exception{
    try {
        return producttypeService.insertSelective(record);
    } catch (Exception e) {
        String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
        logger.error(msg, e);
        throw new Exception(msg, e);
  ...
  public List<ProductTypeVo> selectByExample(ProductTypeModelCriteria example) throws Exception{
    try {
        return producttypeService.selectByExample(example);
    } catch (Exception e) {
        String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
        logger.error(msg, e);
        throw new Exception(msg, e);
  ...
  public int updateByExampleSelective(ProductTypeVo record, ProductTypeModelCriteria example) throws Exception{
    try {
        return producttypeService.updateByExampleSelective(record,example);
    } catch (Exception e) {
        String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
        logger.error(msg, e);
        throw new Exception(msg, e);
  ...
  public int updateByExample(ProductTypeVo record, ProductTypeModelCriteria example) throws Exception{
    try {
        return producttypeService.updateByExample(record,example);
    } catch (Exception e) {
        String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
        logger.error(msg, e);
        throw new Exception(msg, e);
  ...
  public int updateByPrimaryKey(ProductTypeVo record) throws Exception{
    try {
        return producttypeService.updateByPrimaryKey(record);
    } catch (Exception e) {
        String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
        logger.error(msg, e);
        throw new Exception(msg, e);
