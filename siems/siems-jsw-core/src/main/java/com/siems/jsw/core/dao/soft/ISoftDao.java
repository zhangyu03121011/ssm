package com.siems.jsw.core.dao.soft;
 ...
 */
public interface ISoftDao extends IBasePageHelperDao<SoftVo> {
  /**
   * 根据条件查询总数
   * 
   * @param example
   ...
   * @throws Exception
   */
  public int updateByExampleSelective(@Param("record") SoftVo record, @Param("example") SoftModelCriteria example) throws Exception;
   ...
   * @throws Exception
   */
  public int updateByExample(@Param("record") SoftVo record, @Param("example") SoftModelCriteria example) throws Exception;
