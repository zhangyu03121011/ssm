package com.siems.jsw.core.dao.product.type;
 ...
 */
public interface IProductTypeDao extends IBasePageHelperDao<ProductTypeVo> {
  /**
   * 根据条件查询总数
   * 
   * @param example
   ...
   * @throws Exception
   */
  public int updateByExampleSelective(@Param("record") ProductTypeVo record, @Param("example") ProductTypeModelCriteria example) throws Exception;
   ...
   * @throws Exception
   */
  public int updateByExample(@Param("record") ProductTypeVo record, @Param("example") ProductTypeModelCriteria example) throws Exception;
