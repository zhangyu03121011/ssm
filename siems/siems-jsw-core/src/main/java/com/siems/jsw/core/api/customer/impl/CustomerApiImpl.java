package com.siems.jsw.core.api.customer.impl;
 ...
 */
@Service
public class CustomerApiImpl extends BasePageHelperProviderApiImpl<CustomerVo,ICustomerService>  implements ICustomerApi {  
  ...
  public int deleteByExample(CustomerModelCriteria example) throws Exception{
    try {
        return customerService.deleteByExample(example);
    } catch (Exception e) {
        String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
        logger.error(msg, e);
        throw new Exception(msg, e);
  ...
  public int updateByExampleSelective(CustomerVo record, CustomerModelCriteria example) throws Exception{
    try {
        return customerService.updateByExampleSelective(record,example);
    } catch (Exception e) {
        String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
        logger.error(msg, e);
        throw new Exception(msg, e);
  ...
  public int updateByExample(CustomerVo record, CustomerModelCriteria example) throws Exception{
    try {
        return customerService.updateByExample(record,example);
    } catch (Exception e) {
        String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
        logger.error(msg, e);
        throw new Exception(msg, e);
  ...
  public int updateByPrimaryKey(CustomerVo record) throws Exception{
    try {
        return customerService.updateByPrimaryKey(record);
    } catch (Exception e) {
        String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
        logger.error(msg, e);
        throw new Exception(msg, e);
