package com.siems.jsw.core.dao.function;
 ...
 */
public interface IFunctionDao extends IBasePageHelperDao<FunctionVo> {
  /**
   * 根据条件查询总数
   * 
   * @param example
   ...
   * @throws Exception
   */
  public int updateByExampleSelective(@Param("record") FunctionVo record, @Param("example") FunctionModelCriteria example) throws Exception;
   ...
   * @throws Exception
   */
  public int updateByExample(@Param("record") FunctionVo record, @Param("example") FunctionModelCriteria example) throws Exception;
