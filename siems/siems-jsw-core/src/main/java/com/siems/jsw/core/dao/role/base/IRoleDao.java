package com.siems.jsw.core.dao.role.base;
 ...
 */
public interface IRoleDao extends IBasePageHelperDao<RoleVo> {
  /**
   * 根据条件查询总数
   * 
   * @param example
   ...
   * @throws Exception
   */
  public int updateByExampleSelective(@Param("record") RoleVo record, @Param("example") RoleModelCriteria example) throws Exception;
   ...
   * @throws Exception
   */
  public int updateByExample(@Param("record") RoleVo record, @Param("example") RoleModelCriteria example) throws Exception;
