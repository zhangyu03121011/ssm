package com.siems.jsw.core.dao.brand;
 ...
 */
public interface IBrandDao extends IBasePageHelperDao<BrandVo> {
  /**
   * 根据条件查询总数
   * 
   * @param example
   ...
   * @throws Exception
   */
  public int updateByExampleSelective(@Param("record") BrandVo record, @Param("example") BrandModelCriteria example) throws Exception;
   ...
   * @throws Exception
   */
  public int updateByExample(@Param("record") BrandVo record, @Param("example") BrandModelCriteria example) throws Exception;
