package com.siems.jsw.core.dao.customer;
 ...
 */
public interface ICustomerDao extends IBasePageHelperDao<CustomerVo> {
  /**
   * 根据条件查询总数
   * 
   * @param example
   ...
   * @throws Exception
   */
  public int updateByExampleSelective(@Param("record") CustomerVo record, @Param("example") CustomerModelCriteria example) throws Exception;
   ...
   * @throws Exception
   */
  public int updateByExample(@Param("record") CustomerVo record, @Param("example") CustomerModelCriteria example) throws Exception;
