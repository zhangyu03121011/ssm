package com.siems.jsw.core.service.user.role.impl;
...
import com.siems.jsw.core.dao.user.role.IUserRoleDao;
 ...
 */
@Service
public class UserRoleServiceImpl extends BasePageHelperServiceImpl<UserRoleVo,IUserRoleDao>  implements IUserRoleService {  
  ...
  public int updateByExampleSelective(UserRoleVo record, UserRoleModelCriteria example) throws Exception{
    try {
        return userroleDao.updateByExampleSelective(record,example);
    } catch (Exception e) {
        String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
        logger.error(msg, e);
        throw new Exception(msg, e);
