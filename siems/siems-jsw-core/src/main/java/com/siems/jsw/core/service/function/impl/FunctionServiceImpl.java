package com.siems.jsw.core.service.function.impl;
...
import com.siems.jsw.core.dao.function.IFunctionDao;
 ...
 */
@Service
public class FunctionServiceImpl extends BasePageHelperServiceImpl<FunctionVo,IFunctionDao>  implements IFunctionService {  
  ...
  public long countByExample(FunctionModelCriteria example) throws Exception{
    try {
        return functionDao.countByExample(example);
    } catch (Exception e) {
  ...
  public int deleteByExample(FunctionModelCriteria example) throws Exception{
    try {
        return functionDao.deleteByExample(example);
    } catch (Exception e) {
        String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
        logger.error(msg, e);
        throw new Exception(msg, e);
  ...
  public int updateByExampleSelective(FunctionVo record, FunctionModelCriteria example) throws Exception{
    try {
        return functionDao.updateByExampleSelective(record,example);
    } catch (Exception e) {
        String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
        logger.error(msg, e);
        throw new Exception(msg, e);
  ...
  public int updateByExample(FunctionVo record, FunctionModelCriteria example) throws Exception{
    try {
        return functionDao.updateByExample(record,example);
    } catch (Exception e) {
        String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
        logger.error(msg, e);
        throw new Exception(msg, e);
