package com.siems.jsw.core.service.soft.impl;
...
import com.siems.jsw.core.dao.soft.ISoftDao;
 ...
 */
@Service
public class SoftServiceImpl extends BasePageHelperServiceImpl<SoftVo,ISoftDao>  implements ISoftService {  
  ...
  public long countByExample(SoftModelCriteria example) throws Exception{
    try {
        return softDao.countByExample(example);
    } catch (Exception e) {
  ...
  public int deleteByExample(SoftModelCriteria example) throws Exception{
    try {
        return softDao.deleteByExample(example);
    } catch (Exception e) {
        String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
        logger.error(msg, e);
        throw new Exception(msg, e);
  ...
  public int insertSelective(SoftVo record) throws Exception{
    try {
        return softDao.insertSelective(record);
    } catch (Exception e) {
        String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
        logger.error(msg, e);
        throw new Exception(msg, e);
  ...
  public List<SoftVo> selectByExample(SoftModelCriteria example) throws Exception{
    try {
        return softDao.selectByExample(example);
    } catch (Exception e) {
        String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
        logger.error(msg, e);
        throw new Exception(msg, e);
  ...
  public int updateByExampleSelective(SoftVo record, SoftModelCriteria example) throws Exception{
    try {
        return softDao.updateByExampleSelective(record,example);
    } catch (Exception e) {
        String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
        logger.error(msg, e);
        throw new Exception(msg, e);
  ...
  public int updateByExample(SoftVo record, SoftModelCriteria example) throws Exception{
    try {
        return softDao.updateByExample(record,example);
    } catch (Exception e) {
        String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
        logger.error(msg, e);
        throw new Exception(msg, e);
  ...
  public int updateByPrimaryKey(SoftVo record) throws Exception{
    try {
        return softDao.updateByPrimaryKey(record);
    } catch (Exception e) {
        String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
        logger.error(msg, e);
        throw new Exception(msg, e);
