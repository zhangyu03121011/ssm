package com.siems.jsw.core.dao.media;
 ...
 */
public interface IMediaDao extends IBasePageHelperDao<MediaVo> {
  /**
   * 根据条件查询总数
   * 
   * @param example
   ...
   * @throws Exception
   */
  public int updateByExampleSelective(@Param("record") MediaVo record, @Param("example") MediaModelCriteria example) throws Exception;
   ...
   * @throws Exception
   */
  public int updateByExample(@Param("record") MediaVo record, @Param("example") MediaModelCriteria example) throws Exception;
