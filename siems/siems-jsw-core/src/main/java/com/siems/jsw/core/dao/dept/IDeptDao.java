package com.siems.jsw.core.dao.dept;
 ...
 */
public interface IDeptDao extends IBasePageHelperDao<DeptVo> {
  /**
   * 根据条件查询总数
   * 
   * @param example
   ...
   * @throws Exception
   */
  public int updateByExampleSelective(@Param("record") DeptVo record, @Param("example") DeptModelCriteria example) throws Exception;
   ...
   * @throws Exception
   */
  public int updateByExample(@Param("record") DeptVo record, @Param("example") DeptModelCriteria example) throws Exception;
