package com.siems.jsw.core.dao.product.base;
 ...
 */
public interface IProductDao extends IBasePageHelperDao<ProductVo> {
  /**
   * 根据条件查询总数
   * 
   * @param example
   ...
   * @throws Exception
   */
  public int updateByExampleSelective(@Param("record") ProductVo record, @Param("example") ProductModelCriteria example) throws Exception;
   ...
   * @throws Exception
   */
  public int updateByExample(@Param("record") ProductVo record, @Param("example") ProductModelCriteria example) throws Exception;
