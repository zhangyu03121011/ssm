package com.siems.jsw.core.dao.display.hareware;
 ...
 */
public interface IDisplayHarewareDao extends IBasePageHelperDao<DisplayHarewareVo> {
  /**
   * 根据条件查询总数
   * 
   * @param example
   ...
   * @throws Exception
   */
  public int updateByExampleSelective(@Param("record") DisplayHarewareVo record, @Param("example") DisplayHarewareModelCriteria example) throws Exception;
   ...
   * @throws Exception
   */
  public int updateByExample(@Param("record") DisplayHarewareVo record, @Param("example") DisplayHarewareModelCriteria example) throws Exception;
