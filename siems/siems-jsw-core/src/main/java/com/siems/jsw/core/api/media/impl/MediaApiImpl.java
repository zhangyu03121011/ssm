package com.siems.jsw.core.api.media.impl;
...
import com.siems.jsw.api.api.media.IMediaApi;
 ...
 */
@Service
public class MediaApiImpl extends BasePageHelperProviderApiImpl<MediaVo,IMediaService>  implements IMediaApi {  
  ...
  public long countByExample(MediaModelCriteria example) throws Exception{
    try {
        return mediaService.countByExample(example);
    } catch (Exception e) {
  ...
  public int deleteByExample(MediaModelCriteria example) throws Exception{
    try {
        return mediaService.deleteByExample(example);
    } catch (Exception e) {
        String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
        logger.error(msg, e);
        throw new Exception(msg, e);
  ...
  public int insertSelective(MediaVo record) throws Exception{
    try {
        return mediaService.insertSelective(record);
    } catch (Exception e) {
        String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
        logger.error(msg, e);
        throw new Exception(msg, e);
  ...
  public List<MediaVo> selectByExample(MediaModelCriteria example) throws Exception{
    try {
        return mediaService.selectByExample(example);
    } catch (Exception e) {
        String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
        logger.error(msg, e);
        throw new Exception(msg, e);
  ...
  public int updateByExampleSelective(MediaVo record, MediaModelCriteria example) throws Exception{
    try {
        return mediaService.updateByExampleSelective(record,example);
    } catch (Exception e) {
        String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
        logger.error(msg, e);
        throw new Exception(msg, e);
  ...
  public int updateByExample(MediaVo record, MediaModelCriteria example) throws Exception{
    try {
        return mediaService.updateByExample(record,example);
    } catch (Exception e) {
        String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
        logger.error(msg, e);
        throw new Exception(msg, e);
  ...
  public int updateByPrimaryKey(MediaVo record) throws Exception{
    try {
        return mediaService.updateByPrimaryKey(record);
    } catch (Exception e) {
        String msg = ExceptionUtil.getInstance().getExceptionMsg(e);
        logger.error(msg, e);
        throw new Exception(msg, e);
