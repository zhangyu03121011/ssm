package com.siems.jsw.core.dao.product.shop;
 ...
 */
public interface IProductShopDao extends IBasePageHelperDao<ProductShopVo> {
  /**
   * 根据条件查询总数
   * 
   * @param example
   ...
   * @throws Exception
   */
  public int updateByExampleSelective(@Param("record") ProductShopVo record, @Param("example") ProductShopModelCriteria example) throws Exception;
   ...
   * @throws Exception
   */
  public int updateByExample(@Param("record") ProductShopVo record, @Param("example") ProductShopModelCriteria example) throws Exception;
